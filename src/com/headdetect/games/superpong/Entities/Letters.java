...
public class Letters {
	...
	public static void prepare(IGameInterface gameInterface) {
		Letters.gameInterface = gameInterface;
		Letters.mFont = new BitmapFont(gameInterface.getTextureManager(), gameInterface.getAssets(), "text/font.fnt");
		Letters.mFont.load();
	}
	...
	public static Text getText(Vector2 pos, String text, TextOptions options, float scale) {
		Text txt = new Text(pos.x, pos.y, mFont, text, options, gameInterface.getVertexBufferObjectManager());
